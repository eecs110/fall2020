def create_email_message(name:str, amount:int, level:str, gift:str):
...
# create_email_message('Sarah', 100, 'bronze', 'coffee mug')
# create_email_message('Bill Gates', 1000000, 'platinum', 'Wing of Building')
...
people = [
    ...
    ['Dorothy Acevedo', '43878 Deleon Ranch Apt. 191', 'Emilystad', 'Vermont', '05721', 'Social worker', 50, 'bronze', 'coffee mug'],
    ...
    ['Robert Jones', '0816 Tyler Inlet', 'Courtneyberg', 'Nevada', '05095', 'Clinical psychologist', 250, 'gold', 'T-shirt'],
]

for person in people:
    create_email_message(person[0], person[6], person[7], person[8])
